programa
{
	...
	{
	real total, totalCalculado, desconto1, desconto2, desconto3
	cadeia continuar = "S"
 ...
 * @POSICAO-CURSOR = 1414; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {valorAparelho, 12, 42, 13}-{aparelhosQuant, 12, 64, 14}-{desconto, 12, 88, 8}-{total, 15, 6, 5}-{totalCalculado, 15, 13, 14}-{desconto1, 15, 29, 9}-{desconto2, 15, 40, 9}-{desconto3, 15, 51, 9};
